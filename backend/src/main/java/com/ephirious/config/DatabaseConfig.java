...
public class DatabaseConfig {
    ...
    public static String constructDbUrl() {
    ...
    public static void configureDatabase(Configuration configuration) {
    ...
    public static void configureConnectionPool(Configuration configuration) {
