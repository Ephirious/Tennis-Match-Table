...
class StandardSetScoreTest {
    private final StandardSetScore set = new StandardSetScore();
    ...
    private static Stream<Arguments> providePointChainForTestFirstPoints() {
        return Stream.of(
                ...
                Arguments.of(build("f20 s20 f4 s4 f7"), 7)
        );
    }
    ...
    private static Stream<Arguments> providePointChainForTestSecondPoints() {
        return Stream.of(
                ...
                Arguments.of(build("s20 f20 s4 f4 s7"), 7)
        );
    }
    ...
    private static Stream<Arguments> providePointChainWithWinner() {
        return Stream.of(
                ...
                Arguments.of(build("f20 s20 f4 s4 f7"), FIRST),
                Arguments.of(build("s20 f20 s4 f4 s7"), SECOND)
        );
    }
}
